...
public interface JniService {
     ...
     * @return
     */
        String get_cypher(String password, String priv_key);
     ...
     * @return
     */
        String get_private_key(String cipher_keys, String password);
     ...
     * @return
     */
        String get_public_key(String priv_str);
     ...
     * @return
     */
        String signTransaction_tranfer(
            String priv_key_str,
     ...
     * @return
     */
        String create_abi_req_transfer(
            String code,
     ...
     * @return
     */
        String signTransaction_sellram(
     ...
     * @param quant
     */
        String fincreate_abi_req_buyram(
     ...
     * @return
     */
        String signTransaction_delegatebw(
     ...
     * @return
     */
        String signTransaction_undelegatebw(
     ...
     * @return
     */
        String create_abi_req_delegatebw(
     ...
     * @return
     */
        String create_abi_req_undelegatebw(
     ...
     * @return
     */
        String signTransaction_voteproducer(
            String priv_key_str, String contract,
