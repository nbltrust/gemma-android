package com.cybex.base.view.refresh.header;
...
import com.cybex.base.view.refresh.view.MaterialCircleImageView;
import com.cybex.base.view.refresh.view.MaterialProgressDrawable;
...
//                resolveSize(getSuggestedMinimumHeight(), heightMeasureSpec));
    ...
    public void onPullingDown(float percent, int offset, int headHeight, int extendHeight) {
        ...
        mCircleView.setTranslationY(Math.min(offset,
                targetY));//setTargetOffsetTopAndBottom(targetY - mCurrentTargetOffsetTop, true /* requires update */);
    }
