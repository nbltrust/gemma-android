package com.cybex.base.view.switchbutton;
...
public class SwitchButton extends View implements Checkable {
     ...
     * @param paint
     */
    protected void drawCheckedIndicator(
            Canvas canvas,
            int color,
            float lineWidth,
     ...
     * @param paint
     */
    protected void drawUncheckIndicator(
            Canvas canvas,
            int color,
            float lineWidth,
    ...
    private static float optPixelSize(
            TypedArray typedArray,
            int index,
            float def) {
        if (typedArray == null) {return def;}
    ...
    private static int optPixelSize(
            TypedArray typedArray,
            int index,
            int def) {
        if (typedArray == null) {return def;}
    ...
    private static boolean optBoolean(
            TypedArray typedArray,
            int index,
            boolean def) {
        if (typedArray == null) {return def;}
