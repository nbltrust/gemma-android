package com.cybex.base.view.progress.common;
...
public abstract class BaseRoundCornerProgressBar extends LinearLayout {
    ...
    public void setupStyleable(Context context, AttributeSet attrs) {
        ...
        int colorBackgroundDefault = context.getResources()
        ...
        int colorSecondaryProgressDefault = context.getResources()
                .getColor(R.color.round_corner_progress_bar_secondary_progress_default);
    ...
    private void drawSecondaryProgress() {
        drawProgress(layoutSecondaryProgress, max, secondaryProgress, totalWidth, radius, padding,
                colorSecondaryProgress, isReverse);
    }
    ...
    public void setProgress(float progress) {
        if (progress < 0) { this.progress = 0; } else if (progress > max) { this.progress = max; } else {
    ...
    public float getSecondaryProgressWidth() {
        if (layoutSecondaryProgress != null) { return layoutSecondaryProgress.getWidth(); }
        return 0;
    }
    ...
    public void setSecondaryProgress(float secondaryProgress) {
        if (secondaryProgress < 0) { this.secondaryProgress = 0; } else if (secondaryProgress > max) {
