package com.cybex.qrcode.zxing;
...
import com.cybex.qrcode.core.BarcodeType;
import com.cybex.qrcode.core.QRCodeUtil;
import com.cybex.qrcode.core.QRCodeView;
import com.cybex.qrcode.core.ScanResult;
    ...
    protected ScanResult processData(byte[] data, int width, int height, boolean isRetry) {
        ...
        try {
            ...
            if (scanBoxAreaRect != null) {
                source = new PlanarYUVLuminanceSource(data, width, height, scanBoxAreaRect.left, scanBoxAreaRect.top,
