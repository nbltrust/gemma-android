...
import com.hxlx.core.lib.common.imageloader.util.DisplayUtil;
...
public class ShapeImageView extends ImageView {
    ...
    public ShapeImageView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mPressedBorderWidth = array.getDimensionPixelSize(R.styleable.ShapeImageViewStyle_riv_pressed_border_width,
                mBorderWidth);
