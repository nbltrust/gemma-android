...
public class IntentUtils {
     ...
     * @return 意图
     */
    public static Intent getCropPhotoIntent(
            File inputFile,
            File outputFile,
            int aspectX,
            int aspectY,
    ...
    public static Intent getInstallAppIntent(File apkFile) {
        if (apkFile == null || !apkFile.exists() || !apkFile.isFile()) { return null; }
    ...
    public static Intent getUninstallAppIntent(String packageName) {
        if (EmptyUtils.isEmpty(packageName)) { return null; }
    ...
    public static void gotoApp(String packageName) {
        if (EmptyUtils.isEmpty(packageName)) { return; }
     ...
     * @param outputX 输出图片的宽
     */
    public static void gotoCropPhoto(
            Activity activity, int requestCode, File inputFile, File outputFile,
     ...
     */
    public static void gotoCropPhoto(
            Fragment fragment, int requestCode, File inputFile, File outputFile,
            int aspectX, int aspectY, int outputX, int outputY) {
        Intent intent = getCropPhotoIntent(inputFile, outputFile, aspectX, aspectY, outputX, outputY);
     ...
     */
    public static void gotoCropPhoto(
            Activity activity, int requestCode, Uri inputUri, Uri outputUri,
            int aspectX, int aspectY, int outputX, int outputY) {
     ...
     */
    public static void gotoCropPhoto(
            Fragment fragment, int requestCode, Uri inputUri, Uri outputUri,
            int aspectX, int aspectY, int outputX, int outputY) {
        Intent intent = getCropPhotoIntent(inputUri, outputUri, aspectX, aspectY, outputX, outputY);
        startActivityForResult(null, fragment, intent, requestCode);
    }
    ...
    public static boolean gotoPermissionSetting() {
        ...
        switch (romType) {
            case EMUI: // 华为
                ...
                intent.setComponent(
                        new ComponentName("com.huawei.systemmanager", "com.huawei.permissionmanager.ui.MainPageActivity"));
                break;
            case Flyme: // 魅族
