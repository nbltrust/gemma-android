...
/**
 * MVP 中用于解耦合copy from Android Message。
 */
...
public class PresenterMessage implements Parcelable {
    ...
    /**
     * Retrieve the a {@link IView IView} implementation that
     * will receive this PresenterMessage. The object must implement
     * {@link IView#handlePresenterMsg(PresenterMessage)} (com.hxlx.core.lib.mvp.PresenterMessage)
