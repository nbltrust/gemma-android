...
public final class ServiceUtils {
    ...
    public static Set getAllRunningService() {
        ActivityManager am =
                (ActivityManager) BaseApplication.getAppContext().getSystemService(Context.ACTIVITY_SERVICE);
    ...
    public static boolean stopService(final Class<?> cls) {
        Intent intent = new Intent(BaseApplication.getAppContext(), cls);
        return BaseApplication.getAppContext().stopService(intent);
    }
    ...
    public static void bindService(
            ...
            final int flags) {
        Intent intent = new Intent(BaseApplication.getAppContext(), cls);
        BaseApplication.getAppContext().bindService(intent, conn, flags);
    }
    ...
    public static void unbindService(final ServiceConnection conn) {
        BaseApplication.getAppContext().unbindService(conn);
    }
