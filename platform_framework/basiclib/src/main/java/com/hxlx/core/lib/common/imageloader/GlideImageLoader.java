package com.hxlx.core.lib.common.imageloader;
...
import com.hxlx.core.lib.common.imageloader.progress.OnGlideImageViewListener;
import com.hxlx.core.lib.common.imageloader.progress.OnProgressListener;
import com.hxlx.core.lib.common.imageloader.progress.ProgressManager;
import com.hxlx.core.lib.common.imageloader.transformation.GlideCircleTransformation;
...
public class GlideImageLoader {
  ...
  public RequestOptions squareRequestOptions(int placeholderResId) {
    return squareRequestOptions(placeholderResId, placeholderResId);
  }

  public RequestOptions squareRequestOptions(int placeholderResId, int errorResId) {
    return requestOptions(placeholderResId, errorResId)
        .transform(new GlideCircleTransformation());
  }
  ...
  public void loadLocalSquareImage(String localPath, int placeholderResId) {
    load(FILE + localPath, squareRequestOptions(placeholderResId));
  }
  ...
  private void mainThreadCallback(
  ...
  public void setOnGlideImageViewListener(String imageUrl,
