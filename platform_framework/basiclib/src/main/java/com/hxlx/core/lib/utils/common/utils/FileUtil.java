...
import static com.hxlx.core.lib.config.FileConfig.DIR_PUBLIC_ROOT;
...
public class FileUtil {
  ...
  public static byte[] getFileOutputBytes(File file) {
    ...
    Log.d(TAG,
        "getFileOutputBytes.file = " + file + ", bytes.length = "
  ...
  public static boolean writeBytesToFile(File file,
    ...
    Log.d(TAG,
        "writeByteArrayToFile.file = " + file + ", bytes.length = "
            + (bytes == null ? 0 : bytes.length) + ", isAppend = " + isAppend + ", isWriteOk = "
            + isWriteOk);
    return isWriteOk;
  }
  ...
  public static boolean createNewFileAndParentDir(File file) {
    ...
    Log.d(
        "createFileAndParentDir.file = " + file.getAbsolutePath() + ", isCreateNewFileOk = "
            + isCreateNewFileOk);
  ...
  public static boolean copyFile(File sourceFile,
    ...
    Log.d(TAG,
        "copyFile.sourceFile = " + sourceFile + ", destFile = " + destFile + ", isCopyOk = "
            + isCopyOk);
    return isCopyOk;
  }
