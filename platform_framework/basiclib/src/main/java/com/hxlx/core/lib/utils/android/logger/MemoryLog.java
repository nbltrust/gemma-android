...
public class MemoryLog {
    ...
    public static boolean DEBUG_MEMORY = false;      // true表示支持打印内存占用情况，false表示不支持打印占用情况
    ...
    public static void printDalvikMemory(String info) {
        ...
        String content =
                info + "-->totalMemory:" + totalMemory + ",freeMemory:" + freeMemory + ",usedMemory:" + usedMemory
                        + "\n";
        Log.d(
                content);
    }
    ...
    public static void nativePrintMemory(String info) {
        ...
        String content =
                info + "-->totalNativeMemory:" + (totalNativeMemory >> 10) + ",freeNativeMemory:" + (freeNativeMemory
                        >> 10) + ",nativeMemory:" + (nativeMemory >> 10) + "\n";
        Log.d(
                content);
    }
    ...
    public static void memoryApp(String info) {
        ...
        String content =
                info + "-->dalvikPrivateDirty：" + dalvikPrivateDirty + ",dalvikPss:" + dalvikPss + ",dalvikSharedDirty:"
                        + dalvikSharedDirty + ",nativePrivateDirty:" +
                        nativePrivateDirty + ",nativePss:" + nativePss + ",nativeSharedDirty:" + nativeSharedDirty
                        + ",otherPss:" + otherPss + ",otherSharedDirty:" + otherSharedDirty +
                        "\n";
        Log.d(
                content);
    }
