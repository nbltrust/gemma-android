 ...
 */
package com.hxlx.core.lib.utils.common.io;

import android.annotation.SuppressLint;
import android.os.Build;

import com.hxlx.core.lib.utils.android.logger.Log;
import com.hxlx.core.lib.utils.common.io.stream.StringBuilderWriter;
...
public class IOUtils {
    ...
    public static InputStream toBufferedInputStream(InputStream input) throws IOException {
        return com.hxlx.core.lib.utils.common.io.stream.ByteArrayOutputStream.toBufferedInputStream(input);
    }
    ...
    public static byte[] toByteArray(InputStream input) throws IOException {
        com.hxlx.core.lib.utils.common.io.stream.ByteArrayOutputStream output =
                new com.hxlx.core.lib.utils.common.io.stream.ByteArrayOutputStream();
        copy(input, output);
        return output.toByteArray();
    }

    public static byte[] toByteArray(Object input) {
        com.hxlx.core.lib.utils.common.io.stream.ByteArrayOutputStream byteArrayOutputStream = null;
        ObjectOutputStream oos = null;
        try {
            byteArrayOutputStream = new com.hxlx.core.lib.utils.common.io.stream.ByteArrayOutputStream();
    ...
    public static byte[] toByteArray(Reader input, Charset encoding) throws IOException {
        com.hxlx.core.lib.utils.common.io.stream.ByteArrayOutputStream output = new com.hxlx.core.lib.utils.common.io.stream.ByteArrayOutputStream();
    ...
    public static byte[] toByteArray(URLConnection urlConn) throws IOException {
        ...
        try {
            ...
            com.hxlx.core.lib.utils.android.logger.Log.e(e, "");
        } finally {
            inputStream.close();
        }
        return new byte[0];
