...
class IconGenerator(renderer: SvgRenderer, hash: String, x: Float, y: Float, size: Float, padding: Float?, config: Config) {
    ...
    init {
        ...
        // ACTUAL RENDERING
        // Sides
        renderShape(0, Shapes.outer, 2, 3, arrayOf(arrayOf(1, 0), arrayOf(2, 0), arrayOf(2, 3), arrayOf(1, 3), arrayOf(0, 1), arrayOf(3, 1), arrayOf(3, 2), arrayOf(0, 2)))
        // Corners
        renderShape(1, Shapes.outer, 4, 5, arrayOf(arrayOf(0, 0), arrayOf(3, 0), arrayOf(3, 3), arrayOf(0, 3)))
        // Center
        renderShape(2, Shapes.center, 1, null, arrayOf(arrayOf(1, 1), arrayOf(2, 1), arrayOf(2, 2), arrayOf(1, 2)))
