...
public class EnsureDialog {
  ...
  public EnsureDialog setSubTitle(String title) {
    ...
    if ("".equals(title)) {
      ...
      // mTvTitle.setLayoutParams(new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,
   ...
   * @return
   */
  public EnsureDialog setPositiveButton(String text, int color,
  ...
  public EnsureDialog setNegativeButton(String text, int color,
      final View.OnClickListener listener) {
    if ("".equals(text)) {
      mTvCancel.setText("取消");
    } else {
