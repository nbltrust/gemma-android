...
public class GestureCreateActivity extends XActivity {
    ...
    private enum Status {
        //默认的状态，刚开始的时候（初始化状态）
        DEFAULT(R.string.create_gesture_default, R.color.black_content),
        //第一次记录成功
        CORRECT(R.string.create_gesture_correct, R.color.black_content),
        ...
        //二次确认正确
        CONFIRMCORRECT(R.string.create_gesture_confirm_correct, R.color.black_content);
