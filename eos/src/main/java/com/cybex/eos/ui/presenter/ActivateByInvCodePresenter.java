...
public class ActivateByInvCodePresenter extends XPresenter<ActivateByInvCodeFragment> {
     ...
     * 创建账户
     */
    public void createAccount(final String eos_username, final String private_key, final String public_key, final String
            password, final String invCode, final String passwordTip){
