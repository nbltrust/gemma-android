package com.cybex.eos.ui.presenter;
...
import com.cybex.eos.config.HttpConst;
...
import com.cybex.eos.config.ParamConstants;
import com.cybex.eos.event.OrderIdEvent;
import com.cybex.eos.ui.JNIUtil;
import com.cybex.eos.ui.model.request.UserRegisterReqParams;
import com.cybex.eos.ui.model.request.WXPayInitialOrderReqParams;
import com.cybex.eos.ui.model.response.UserRegisterResult;
import com.cybex.eos.ui.model.response.WXPayBillResult;
...
import com.cybex.eos.ui.request.UserRegisterRequest;
import com.cybex.eos.ui.request.WXPayBillRequst;
import com.cybex.eos.ui.request.WXPayInitialOrderRequest;
import com.cybex.eos.ui.request.WXPayPlaceOrderRequest;
import com.cybex.eos.ui.request.WXPayQueryOrderInfoRequest;
...
public class ActivateByRMBPresenter extends XPresenter<ActivateByRMBFragment> {
     ...
     * @param rmbPrice
     */
    public void getPrepaidInfo(String account_name, String public_key, final String rmbPrice){
     ...
     * 创建账户
     */
    public void createAccount(final String eos_username, final String private_key, final String public_key, final String password,  final String
            orderId, final String passwordTip){
